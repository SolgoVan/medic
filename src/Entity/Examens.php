...
class Examens
{
    ...
    #[ORM\OneToMany(mappedBy: 'examen', targetEntity: Consultations::class, orphanRemoval: true)]
    ...
    public function removeConsultation(Consultations $consultation): static
    {
        if ($this->consultations->removeElement($consultation)) {
            ...
            if ($consultation->getExamen() === $this) {
                $consultation->setExamen(null);
            }
        }
